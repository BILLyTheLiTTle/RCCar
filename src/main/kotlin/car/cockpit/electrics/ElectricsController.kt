...
class ElectricsController{
    ...
    fun setDirectionLights(
        @RequestParam(value = "direction", defaultValue = CorneringLight.DEFAULT) direction: String
    ...
    fun setMainLightsState(@RequestParam(value = "state", defaultValue = MainLight.DEFAULT) state: String) =
