...
class EngineSystem {
    ...
    fun startEngine(
        ...
        ThrottleBrakePedal.lastRequestId = -1
        SteeringWheel.lastRequestId = -1

        Companion.nanohttpClientIp = if (nanohttpClientIp == "0.0.0.0") "10.0.2.15" else nanohttpClientIp
        Companion.nanohttpClientPort = nanohttpClientPort
